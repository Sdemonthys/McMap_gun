...
function smithed.damage:v0.2.0/entity/armor/toughness

#!dbg score "#damage", "smithed.damage"

# then protection
function smithed.damage:v0.2.0/entity/armor/protection

#!dbg score "#damage", "smithed.damage"

function smithed.damage:v0.2.0/entity/armor/blast_protection

#!dbg score "#damage", "smithed.damage"

# finally resistance
function smithed.damage:v0.2.0/entity/armor/resistance
