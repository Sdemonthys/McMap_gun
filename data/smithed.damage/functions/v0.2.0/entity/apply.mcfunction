...
execute if entity @s[type=player] run function smithed.damage:v0.2.0/entity/health/calculate_modifier
execute if entity @s[type=!player] run function smithed.damage:v0.2.0/entity/health/get_entity_health
