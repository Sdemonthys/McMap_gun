...
execute if score #temp gun.data matches 0 positioned ~ ~1.96 ~ as @e[type=item,predicate=gun:item_is_gun,distance=..16,limit=1,sort=nearest] run function gun:abilities/ability
