...
scoreboard players set #update Level 0
...
execute if score #update Level matches 1.. run function gun:event/update/copy_slot with storage gun:data current_item
