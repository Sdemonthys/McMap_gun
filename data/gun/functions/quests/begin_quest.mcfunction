...
execute if score @s wich_npc matches 1 run tellraw @p[tag=talked_to_dude1,tag=talked_to_guy1,tag=quest_interaction,tag=!stole_money] ["",{"text":"Test", "color": "#40E0D0"},{"text": " Get the money, quick !","color": "#FFFF00"}]