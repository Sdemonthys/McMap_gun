...
execute if score #level gun.data > @s Physical run tellraw @s [{"text": "Your Physical Skill needs to be at least ","bold":true,"color":"dark_red"},{"score":{"name": "#level","objective": "gun.data"}},{"text": " to use this weapon"}]
