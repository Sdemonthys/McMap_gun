...
execute if score #level gun.data > @s Electrical run tellraw @s [{"text": "Your Electrical Skill needs to be at least ","blod":true,"color":"dark_red"},{"score":{"name": "#level","objective": "gun.data"}},{"text": " to use this weapon"}]
