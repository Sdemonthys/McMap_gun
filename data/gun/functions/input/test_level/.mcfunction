...
execute if score #level gun.data > @s Level run tellraw @s [{"text": "Your level needs to be at least ","blod":true,"color":"dark_red"},{"score":{"name": "#level","objective": "gun.data"}},{"text": " to use this weapon"}]
