...
data modify entity @e[type=chest_minecart,tag=gui,limit=1] Items set from storage gun:gui_storage data.page[0]
execute if entity @s[tag=unlocked_skill_tree] run scoreboard players set @s skill_gui_page 1
