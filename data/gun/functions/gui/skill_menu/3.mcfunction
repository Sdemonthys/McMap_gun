...
execute unless data storage gun:data gui_items[{Slot:9b,id:"minecraft:compass"}] run function gun:gui/skill_menu/page3/9
execute unless data storage gun:data gui_items[{Slot:10b,id:"minecraft:compass"}] run function gun:gui/skill_menu/reset
execute unless data storage gun:data gui_items[{Slot:11b,id:"minecraft:compass"}] run function gun:gui/skill_menu/page3/11
execute unless data storage gun:data gui_items[{Slot:12b,id:"minecraft:compass"}] run function gun:gui/skill_menu/reset
execute unless data storage gun:data gui_items[{Slot:13b,id:"minecraft:compass"}] run function gun:gui/skill_menu/reset
execute unless data storage gun:data gui_items[{Slot:14b,id:"minecraft:compass"}] run function gun:gui/skill_menu/page3/14
execute unless data storage gun:data gui_items[{Slot:15b,id:"minecraft:compass"}] run function gun:gui/skill_menu/page3/15
...
execute unless data storage gun:data gui_items[{Slot:19b,id:"minecraft:compass"}] run function gun:gui/skill_menu/page3/19
execute unless data storage gun:data gui_items[{Slot:20b,id:"minecraft:compass"}] run function gun:gui/skill_menu/reset
execute unless data storage gun:data gui_items[{Slot:21b,id:"minecraft:compass"}] run function gun:gui/skill_menu/page3/21
