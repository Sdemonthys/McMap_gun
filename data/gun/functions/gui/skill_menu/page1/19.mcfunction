execute unless entity @p[tag=have_skill_tree_page1_ability_1] run tellraw @p [{"text": "You don't meet the requierements to unlock this ability","italic":false,"color": "dark_red"}]
...
execute if score @p[tag=have_skill_tree_page1_ability_1] skill_tree_ability_points matches 1.. run function gun:gui/skill_menu/page1/19_pass
